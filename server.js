...
app.use(expressJWT({secret: process.env.SECRET}).unless({path: ['/', '/favicon.ico', '/css/main.css', '/js/main.js', '/css/main.css.map', '/js/main.js.map', '/cooks', '/login', '/cooks/login', '/consumers', '/consumers/login', '/cookSignUp', '/consumerSignUp', '/cooks/displayAll']}));
